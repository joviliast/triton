...
@triton.jit
def _bwd_kernel_dk_dv(dk, dv, Q, k, v, sm_scale, DO, M, D,
                      # shared by Q/K/V/DO.
...
@triton.jit
def _bwd_kernel_dq(dq, q, K, V, do, m, D,
                   # shared by Q/K/V/DO.
...
def _attn_bwd(Q, K, V, sm_scale, DO, DQ, DK, DV, M, D,
              ...
              BLOCK_M2: tl.constexpr, BLOCK_N2: tl.constexpr, BLK_SLICE_FACTOR: tl.constexpr):
    ...
    dk, dv = _bwd_kernel_dk_dv(dk, dv, Q, k, v, sm_scale, DO, M, D, stride_tok, stride_d, H, N_CTX, MASK_BLOCK_M1,
                               BLOCK_N1, BLOCK_DMODEL, start_n, start_m, num_steps, MASK=True)

    start_m += num_steps * MASK_BLOCK_M1
    num_steps = (N_CTX - start_m) // BLOCK_M1

    # Compute dK and dV for non-masked blocks.
    dk, dv = _bwd_kernel_dk_dv(dk, dv, Q, k, v, sm_scale, DO, M, D, stride_tok, stride_d, H, N_CTX, BLOCK_M1, BLOCK_N1,
                               BLOCK_DMODEL, start_n, start_m, num_steps, MASK=False)
    ...
    dq = _bwd_kernel_dq(dq, q, K, V, do, m, D, stride_tok, stride_d, H, N_CTX, BLOCK_M2, MASK_BLOCK_N2, BLOCK_DMODEL,
                        start_m, end_n - num_steps * MASK_BLOCK_N2, num_steps, MASK=True)
    end_n -= num_steps * MASK_BLOCK_N2
    # stage 2
    num_steps = end_n // BLOCK_N2
    dq = _bwd_kernel_dq(dq, q, K, V, do, m, D, stride_tok, stride_d, H, N_CTX, BLOCK_M2, BLOCK_N2, BLOCK_DMODEL,
